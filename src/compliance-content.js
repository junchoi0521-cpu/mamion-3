...
export const CONSENT_SECTIONS = [
  {
    ...
    intro: '마미온 임신축하선물 신청 및 상담 안내를 위해 아래와 같이 개인정보를 수집·이용합니다.',
    blocks: [
      {
        title: '수집·이용 목적',
        items: [
          '임신축하선물 신청 접수 및 신청자 본인 확인',
          '신청 내용 확인, 상담 안내, 일정 조율 및 고객 문의 응대',
          '선물 지급 대상 확인 및 배송 안내',
  ...
  },
  {
    ...
    intro: '마미온 임신축하선물 신청 및 태아보험 상담 안내를 위해 아래와 같이 신청자의 개인정보를 제3자에게 제공하는 것에 동의합니다.',
    blocks: [
      { title: '개인정보를 제공받는 자', items: THIRD_PARTY_RECIPIENTS },
      {
        title: '개인정보 제공 목적',
        items: [
          '임신축하선물 신청 확인 및 상담 안내',
          '태아보험 상담, 보험상품 안내 및 상담 일정 조율',
      ...
      },
      {
        ...
        items: [
          ...
          '다만, 동의하지 않을 경우 임신축하선물 신청, 태아보험 상담 안내 및 선물 지급이 제한될 수 있습니다.',
        ],
      },
      {
        title: '안내',
  ...
  },
  {
    ...
    intro: '마미온 임신축하선물은 신청 후 담당자가 순차적으로 연락드리며, 상담 진행 후 선물이 자택으로 배송되는 구조임을 확인했습니다.',
    blocks: [],
  },
  {
    id: 'marketing',
...
export const POLICY_CONTENT = [
  {
    ...
    intro: '마미온은 임신축하선물 신청 및 상담 안내를 위해 아래 개인정보를 수집합니다.',
  ...
  },
  {
    ...
    items: [
      ...
      '상담 안내, 일정 조율, 고객 문의 응대',
      '선물 지급 대상 확인 및 배송 안내',
      '중복 신청, 허위 신청 및 부정 이용 방지',
      '광고성 정보 수신동의 시 이벤트, 혜택 및 서비스 안내',
    ],
  },
  {
    title: '3. 보유 및 이용기간',
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        title: '제공 목적',
        items: ['임신축하선물 신청 확인, 태아보험 상담 안내, 상담 일정 조율, 선물 지급 및 배송 안내'],
      },
      { title: '제공 항목', items: [PERSONAL_INFO_ITEMS.join(', ')] },
      { title: '보유기간', items: [THIRD_PARTY_RETENTION_PERIOD] },
    ],
  },
  {
    title: '5. 광고성 정보 수신동의',
    items: [
      ...
      '광고성 정보 수신동의는 선택 동의이며, 미동의해도 임신축하선물 신청은 가능합니다.',
  ...
  },
  {
    title: '6. 동의 거부권',
    items: [
      '필수 동의를 거부할 경우 임신축하선물 신청, 상담 안내, 선물 지급이 제한될 수 있습니다.',
...
export const TERMS_CONTENT = [
  {
    title: '1. 서비스 내용',
    paragraphs: [
      '마미온은 예비맘을 대상으로 임신축하선물 신청 접수, 신청 확인, 상담 안내, 선물 안내 및 배송 관련 안내 서비스를 제공합니다.',
      '마미온 임신축하선물은 신청자 정보 확인 및 상담 진행 후 지급되는 구조입니다.',
    ],
  },
  {
    title: '2. 신청 및 이용 조건',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '신청 정보 확인, 상담 진행, 배송 안내 절차에 따라 순차적으로 안내됩니다.',
    ],
  },
  {
    title: '4. 금지 표현 및 운영 원칙',
    items: [
...
export function buildConsentPayload(source = {}, agreedAt = new Date().toISOString()) {
  return CONSENT_SECTIONS.reduce((payload, section) => {
    ...
    payload[section.sheetColumn] = consentLabel(checked);
    return payload;
  }, {
