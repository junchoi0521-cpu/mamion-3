...
function ApplySection({ onSubmitSuccess }) {
  ...
  const [form, setForm] = useState({ name: '', phone: '', dueDate: '', region: '', request: '', weeks: '', privacy: false, thirdParty: false, marketing: false });
